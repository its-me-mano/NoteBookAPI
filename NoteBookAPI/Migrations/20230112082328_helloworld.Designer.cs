...
namespace NoteBookAPI.Migrations
{
    ...
    [Migration("20230112082328_helloworld")]
            ...
            modelBuilder.Entity("NoteBookAPI.Entities.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 343, DateTimeKind.Local).AddTicks(4272),
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 343, DateTimeKind.Local).AddTicks(4394),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Line1 = "hello",
                            Line2 = "solunga",
                            StateName = "tamilnadu",
            ...
            modelBuilder.Entity("NoteBookAPI.Entities.Email", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("f46f9dba-8a1c-4dd9-a8ea-c572a83be0be"),
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 343, DateTimeKind.Local).AddTicks(7061),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("8c50f920-4b3a-4565-a8b6-0b635b429a98"),
                            CreateBy = new Guid("68417748-6864-4866-8d9b-b82ae29da396"),
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 343, DateTimeKind.Local).AddTicks(7115),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NoteBookAPI.Entities.Phone", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("f46f9dba-8a1c-4dd9-a8ea-c572a83be0be"),
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 343, DateTimeKind.Local).AddTicks(5871),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("8c50f920-4b3a-4565-a8b6-0b635b429a98"),
                            CreateBy = new Guid("68417748-6864-4866-8d9b-b82ae29da396"),
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 343, DateTimeKind.Local).AddTicks(5914),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NoteBookAPI.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateBy = new Guid("f46f9dba-8a1c-4dd9-a8ea-c572a83be0be"),
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 341, DateTimeKind.Local).AddTicks(3858),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Sakthi",
                            LastName = "Vel",
                            UpdateBy = new Guid("00000000-0000-0000-0000-000000000000"),
                        ...
                        new
                        {
                            ...
                            CreateBy = new Guid("68417748-6864-4866-8d9b-b82ae29da396"),
                            DateCreated = new DateTime(2023, 1, 12, 13, 53, 28, 341, DateTimeKind.Local).AddTicks(9642),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Manoj",
                            LastName = "Kumar",
                            UpdateBy = new Guid("00000000-0000-0000-0000-000000000000"),
